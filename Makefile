...
default: GRASP Phewas_Catalog GWAS_Catalog GWAS_DB Fantom5 DHS Regulome
...
${DEST_DIR}/GRASP.txt: ${DEST_DIR}
	...
	unzip -c ${DEST_DIR}/GRASP.zip > ${DEST_DIR}/GRASP.txt
...
${DEST_DIR}/Fantom5.txt: ${DEST_DIR}
	...
	cat ${DEST_DIR}/DHS.txt | perl STOPGAP_FDR.pl > ${DEST_DIR}/Fantom5.fdrs
...
${DEST_DIR}/Regulome.txt: ${DEST_DIR}
	...
	awk 'BEGIN {FS="\t"} { print $1,$2,$2 + 1,$4 }' ${DEST_DIR}/regulome.tmp > ${DEST_DIR}/Regulome.txt
